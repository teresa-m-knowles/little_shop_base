...
RSpec.describe Discount do
  describe 'validations' do
    ...
    it { should validate_numericality_of(:item_quantity_for_discount).is_greater_than(0) }
    it { should validate_numericality_of(:item_quantity_for_discount).only_integer }
